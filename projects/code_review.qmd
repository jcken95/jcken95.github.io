---
  ...
  subtitle: ""
  description: "Software developers have some really good approaches to code review. Here's a data scientists plea to listen to the software developers!"
  format: html
  date: 09-11-2024
  about:
    template: marquee
...
I'd also like to be upfront here and say there is very little original thought going into this. Software developers have written a lot of good content on what makes good code review. I'll link to some further reading and inspiration and the end. The aim here is to
...
We will first think about the literal act of reviewing code, and then later we will think about what the reviewer should look for and how they should approach requesting changes. If you're comfortable with annotating someone else's code via a pull request, [skip ahead](code_review.html#why-do-we-review-code).
...
Once you've finished reviewing, click `Review changes` in the top right of the browser winder. Take some time to write encouraging feedback in the comment box.
...
There is one fairly obvious answer to this question: to check the code does what it should. But there are a whole host of benefits to teams performing code review.
...
Nit picks, or just nits, are annoying (and something I do too much, sorry colleages), but they are an inevitable apart of code review
...
You can also construct pull requests which [merge into a branch other than main](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request#changing-the-branch-range-and-destination-repository) -- so you could actually make some of the fixes yourself and contribute to the pull request!
...
It's also worth setting up a (video) meeting about the code. Communication nuances can get lost via a written format. Once you've done this, make a note of the main points/actions of the call somewhere in the pull request.
